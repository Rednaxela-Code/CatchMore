    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Catch>().HasData(
                new Catch() { Id = 2, Date = DateTime.Now, Species = "Perch", Weight = 2, Length = 50, SessionId = 10 },
                new Catch() { Id = 3, Date = DateTime.Now, Species = "Perch", Weight = 1.5, Length = 45, SessionId = 11 }
                );
        }
    }
}
